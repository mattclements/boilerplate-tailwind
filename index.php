	...
	<header role="banner" class="lg:flex // items-center // justify-between // bg-teal // white // p-4">
		<nav class="w3/4 // border-2">
			<ul class="flex // flex-wrap // space-between // list-reset // font-serif">
				...
				<li><a href="#" class="text-white // no-underline // bg-teal-darkest // rounded // py-2 // px-4 // mr-4">About</a></li>
				<li><a href="#" class="text-white // no-underline // bg-teal-darkest // rounded // py-2 // px-4 // mr-4">Services</a></li>
				<li><a href="#" class="text-white // no-underline // bg-teal-darkest // rounded // py-2 // px-4 // mr-4">Portfolio</a></li>
				<li><a href="#" class="text-white // no-underline // bg-teal-darkest // rounded // py-2 // px-4 // mr-4">Portfolio</a></li>
				<li><a href="#" class="text-white // no-underline // bg-teal-darkest // rounded // py-2 // px-4 // mr-4">Portfolio</a></li>
				<li><a href="#" class="text-white // no-underline // bg-teal-darkest // rounded // py-2 // px-4 //">Contact</a></li>
			</ul>
		</nav>

		<div class="w1/4 // bg-teal-darker // text-white // p-4 // border-2">
			Your Harem Coran
		</div>
